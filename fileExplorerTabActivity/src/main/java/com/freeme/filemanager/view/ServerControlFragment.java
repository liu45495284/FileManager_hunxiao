...
/*/
 Modified by tyd xueweili for lazy load 20160509
//*/
public class ServerControlFragment extends BaseFragment implements IBackPressedListener {
    ...
    private static final int OPERATION_MENU_CLEAN = 60;
    //*/ freeme.liuhaoran , 20160715 , for tyd00610711 JE
    ...
    public View onFragmentCreateView(LayoutInflater inflater,
        ...
        handler.sendEmptyMessageDelayed(VIEW_DELAY_LOAD,200);
        return mRootView;
    }
    ...
    public void init() {
        ...
        stub.setLayoutResource(R.layout.server_control_activity);
        stub.inflate();

        // Set the application-wide context global, if not already set
        Context myContext = Globals.getContext();
        Log.i("liuhaoran","init ==== myContext=" + myContext );
        if (myContext == null && mActivity != null) {
            myContext = mActivity.getApplicationContext();
            Log.i("liuhaoran","init ==== myContext111==" + myContext );
            if (myContext == null) {
        ...
        Ttext = (TextView) mRootView.findViewById(R.id.textView1);
        Ttext1 = (TextView) mRootView.findViewById(R.id.textView2);
    ...
    public void fragmentShow() {
        ...
        UiUpdater.registerClient(handler);
        //*/ freeme.liuhaoran , 20160726 , tyd00612610
        /*/
        updateUi();
        //*/
        handler.sendEmptyMessageDelayed(0, 200);
        //*/
        Log.i("liuhaoran", "Registered for wifi updates");
    ...
    public void onPrepareOptionsMenu(Menu menu) {
        menu.clear();
        menu.add(0, OPERATION_MENU_CLEAN, 1,
                getResources().getString(R.string.garbage_clean_title))
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        case OPERATION_MENU_CLEAN:
            Intent intent = new Intent(mActivity, GarbageCleanupActivity.class);
            startActivity(intent);
            break;
        }
        return true;
    ...
    public void updateUi() {
        ...
        //modified by tyd wulianghuan 20130527
       // setText(R.id.wifi_state, isWifiReady ? wifiId : mActivity.getString(R.string.no_wifi_hint));
        ...
        startStopButton.setBackgroundResource(R.drawable.btn_bottom_last);
        TextView startStopButtonText = (TextView) mRootView.findViewById(R.id.start_stop_button_text);
        //modify by tyd liuyong 20140811 for freeme
        if (isWifiReady) {
           ...
           // if(running){
            ...
            //  Ttext1.setVisibility(View.GONE);
           // }
            startStopButtonText.setTextColor(Color.WHITE);
            ...
            startStopButton.setBackgroundResource(R.drawable.wifi_state_button);
            startStopButtonText.setText(R.string.no_wifi);
            //startStopButtonText.setCompoundDrawablesWithIntrinsicBounds(0, 0, 0, 0);
            startStopButtonText.setTextColor(R.color.no_file);
...
//                return;
    ...
    private void warnIfNoExternalStorage() {
        ...
        if (!storageState.equals(Environment.MEDIA_MOUNTED)) {
            ...
            Toast toast = Toast.makeText(mActivity, R.string.storage_device_umouonted, Toast.LENGTH_LONG);
