...
public class FileListCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        Log.i("FileListCursorAdapter", "fileInfo2 = " + fileInfo  + fileInfo.fileName + cursor.getPosition());
        if (fileInfo == null) {
    ...
    public Collection<FileInfo> getAllFiles() {
            ...
            do {
                ...
                if (fileInfo != null) {
                    ...
                    if (Settings.instance().getShowDotAndHiddenFiles()) {
                        ...
                        Log.i("FileListCursorAdapter", "fileInfo = " + fileInfo + fileInfo.fileName);
                    }else {
                    if (!fileInfo.isHidden) {
                        mFileNameList.add(fileInfo);
                        Log.i("FileListCursorAdapter", "fileInfo1 = " + fileInfo  + fileInfo.fileName);
                    }
                    }
                    // */end
                }
        ...
        // return mFileNameList.values();
        Log.i("FileListCursorAdapter", "mFileNameList = " + mFileNameList.size());
        return mFileNameList;
    }
