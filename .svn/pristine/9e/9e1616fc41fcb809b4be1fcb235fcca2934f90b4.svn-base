...
public class FileExplorerPreferenceActivity extends PreferenceActivity implements OnSharedPreferenceChangeListener {
    ...
    public static boolean isReadRoot(Context context) {
        ...
        boolean isReadRootWhenSettingPrimaryFolderWithoutSdCardPrefix = false;
        if(Environment.isExternalStorageRemovable()){
            isReadRootWhenSettingPrimaryFolderWithoutSdCardPrefix= !getPrimaryFolder(context).startsWith(Util.getSdDirectory());
        }
