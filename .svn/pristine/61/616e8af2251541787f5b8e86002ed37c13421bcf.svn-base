...
public class FileInfo {
    ...
    public String getFileMimeType() {
        if(mFileMimeType == null && !isDirectory()){
            mFileMimeType = EditUtility.getMimeTypeForFile(mContext, mFile);
            FileManagerLog.d(TAG, "Get mimeType for file: " + mFileMimeType);
        }
